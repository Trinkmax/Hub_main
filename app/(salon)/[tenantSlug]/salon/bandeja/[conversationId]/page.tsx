...
import { Composer } from '@/app/(manager)/[tenantSlug]/mensajeria/inbox/_components/composer'
import { MessageThread } from '@/app/(manager)/[tenantSlug]/mensajeria/inbox/_components/message-thread'
