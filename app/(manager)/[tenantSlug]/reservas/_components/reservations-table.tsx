                  ...
                  return (
                    <DataTableRow
                      ...
                      className={cn(
                        ...
                        r.id === highlightId && 'bg-success/10 hover:bg-success/10',
                      )}
                    >
                      {groupByDay ? null : (
                        <DataTableCell>
                      ...
                      <DataTableCell>
                        {/* Servicio + dónde se sienta en dos líneas: eran dos
                            columnas y la tabla ya scrolleaba de más al sumar la
                            seña. El lugar sale de `placeLabel`, igual que en el
                            calendario: "Pizza libre · Planta Alta" si la
                            reserva del evento tiene planta. */}
                        <div className="flex flex-col leading-tight">
