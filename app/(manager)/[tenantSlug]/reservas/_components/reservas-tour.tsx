  ...
  return {
    ...
    steps: [
      ...
      },
      {
        ...
        body: (
          <>
            También podés reservar desde <strong>Agenda → Calendario</strong>, que tiene su propia
            guía; al guardar, cada lado te devuelve a donde estabas. Y esta guía queda siempre en el
            botón <strong>¿Cómo funciona?</strong>.
          </>
        ),
      },
    ],
